...
ActiveRecord::Schema[7.0].define(version: 2025_01_02_205243) do
  ...
  create_table "match_positions", force: :cascade do |t|
    ...
    t.bigint "match_id"
    t.bigint "player_id"
    t.index ["match_id", "player_id"], name: "index_match_positions_on_match_id_and_player_id", unique: true
